...
if($username) {
	...
	require_once DT_ROOT.'/include/module.func.php';//DF
	...
	(@include DT_ROOT.'/module/company/'.$file.'.inc.php') or dheader(DT_URL);//DF
} else {
	//防止恶意绑定IP
	if(strpos($DT_URL, DT_DOMAIN ? DT_DOMAIN : DT_URL) === false) exit(header("HTTP/1.1 404 Not Found"));//DF
