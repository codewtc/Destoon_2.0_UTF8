...
<td>
<input type="radio" name="member[reg]" value="1" checked id="reg_1" onclick="reg(1);"/><label for="reg_1"> 企业会员</label>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="member[reg]" value="0" id="reg_0" onclick="reg(0);"/><label for="reg_0"> 个人会员</label>
</td>
</tr>
<tr>
...
<td><?php echo ajax_category_select('member[catid]', '请选择', 0, 4);?>&nbsp;<span id="dcatid" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">主要经营范围 <span class="f_red">*</span></td>
<td><input type="text" size="80" name="member[business]" id="business"/></td>
</tr>
<tr>
<td class="tl">经营模式</td>
<td>
