...
class article {
    ...
    function article($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','level','title','style','fee','introduce','thumb','tag','keyword','author','copyfrom','fromurl','voteid','status','username','addtime','editor','edittime','ip','template', 'islink', 'linkurl','note');
    }
