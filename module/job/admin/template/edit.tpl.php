...
<td><?php echo ajax_category_select('post[catid]', '', $catid, $moduleid);?> <br/><span id="dcatid" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">招聘部门 </td>
...
<td><?php echo dcalendar('post[totime]', $totime);?> &nbsp;<span class="f_gray">不填表示长期有效</span> <span id="dposttotime" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">会员信息</td>
<td>
