...
class buy {
    ...
    function buy($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','areaid','typeid','pid','level','title','style','fee','introduce','amount','price','standard','pack','days','thumb','thumb1','thumb2','tag','keyword','status','username','totime','editor','addtime','adddate','edittime','editdate','ip','template','linkurl','note','company','truename','telephone','mobile','address','email','msn','qq');
    }
