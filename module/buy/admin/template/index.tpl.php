...
<td>
<?php if($v['username']) { ?>
<a href="javascript:_user('<?php echo $v['username'];?>');" title="<?php echo $v['company'];?>"><?php echo $v['username'];?></a>
<?php } else { ?>
	<?php echo $v['ip'];?>
<?php } ?>
</td>
...
批量延长过期时间 <input type="text" size="3" name="days" id="days" value="<?php echo $MOD['over_days'];?>"/> 
