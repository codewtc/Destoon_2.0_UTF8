...
class exhibit {
    ...
    function exhibit($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','level','title','style','fee','fromtime','totime','city','address','hallname','remark','thumb','keyword','sponsor','undertaker','truename','addr','telephone','mobile','fax','email','msn','qq','status','username','addtime','editor','edittime','ip','template','linkurl','note');
    }
