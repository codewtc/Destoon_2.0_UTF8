...
<tr>
<td class="tl">留言人</td>
<td><a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?username=<?php echo $username;?>" target="_blank" class="t"><?php echo $username ? $username : 'Guest';?></a> IP - <?php echo $ip;?></td>
</tr>
<tr>
