...
&nbsp;
<?php if($v['username']) { ?>
<a href="?moduleid=2&action=show&username=<?php echo $v['username'];?>"><?php echo $v['username'];?></a> 
<?php } else { ?>
Guest
<?php } ?>
<?php if($v['hidden']) { ?>
...
<?php } ?>
&nbsp;
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=<?php echo $action;?>&ip=<?php echo $v['ip'];?>"><?php echo $v['ip'];?></a>
</div>
